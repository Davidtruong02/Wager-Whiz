...
const stripe = require('@stripe/stripe-js')('sk_test_51PELwo02NrnR8qBBxppttSvPkOBYGt2kf55WHR4JYQyYi3dbZUHYFAPZP9JNec9rcIramD4eHx4B4uzRL50u1kai00Ah5h5N31');
const express = require('express');
//const app = express();
...
app.post('/create-checkout-session', async (req, res) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    mode: 'subscription',
    success_url: `${PORT}/?success=true&session_id={CHECKOUT_SESSION_ID}`,
...
app.listen(3001, () => console.log('Running on port'));
